...
public interface AccountsApi
{
    ...
    @Operation(summary = "Adds a new Account", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountManagement"})
    ...
    @Operation(summary = "Changes account type.", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountType"})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "The account type has been changed."),
            ...
            @ApiResponse(responseCode = "200", description = "An unknown error has occured.", content = @Content(schema = @Schema(implementation = Error.class)))})
    @RequestMapping(value = "/Accounts/{iban}/{type}", produces = {"application/json"}, method = RequestMethod.POST)
    ...
    @Operation(summary = "Deletes an account by Iban", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountManagement"})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "The account object has been deleted."),
            ...
            @ApiResponse(responseCode = "406", description = "Not Accepted. The balance is more than 0.", content = @Content(schema = @Schema(implementation = Error.class))),
    ...
    @Operation(summary = "Gets an account balance by Iban.", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountBalance"})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Balance of the account has been returned."),
            ...
            @ApiResponse(responseCode = "200", description = "An unknown error has occured.", content = @Content(schema = @Schema(implementation = Error.class)))})
    @RequestMapping(value = "/Accounts/{iban}/getBalance", produces = {"application/json"}, method = RequestMethod.GET)
    ...
    @Operation(summary = "Gets an account by Iban.", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountManagement"})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "An account object has been returned.", content = @Content(schema = @Schema(implementation = Account.class))),
    ...
    @Operation(summary = "Gets all accounts", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountManagement"})
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Paginated accounts have been returned")})
    ...
    @Operation(summary = "Updates an existing account", description = "", security = {@SecurityRequirement(name = "bearerAuth")}, tags = {"AccountManagement"})
